...
// import { defineConfig, defineCollection, s } from "velite";
// import { processGalleryFolder, GalleryImage } from "@/lib/gallery-processor";
...
// const computedFields = <T extends BaseData>(data: T): T & ProcessedData => {
//   // Process images if a galleryFolder is specified
//   let gallery: GalleryImage[] = [];
  
//   if (typeof data.galleryFolder === 'string' && data.galleryFolder) {
//     gallery = processGalleryFolder(data.galleryFolder);
//   } else if (typeof data.gallery === 'string' && data.gallery) {
//     // If gallery is a string, try to use it as a folder path
//     gallery = processGalleryFolder(data.gallery);
//   }
  
//   // Use the processed gallery or the gallery array if it's already an array
//   const finalGallery: GalleryImage[] = Array.isArray(data.gallery) 
//     ? data.gallery 
//     : gallery;
